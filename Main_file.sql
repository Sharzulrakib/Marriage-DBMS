...
create or replace trigger dob_age before insert or update on brides
 for each row

BEGIN
   :new.age := get_age(:new.e_date);
END;
...
insert into brides(b_id,name,profession,height,salary,phone_no,home_town,religion,e_date)values(1,'tonu','student','5 Fit 5 Inc',0,'+88015','bogra','muslim','19-dec-2016');
insert into brides(b_id,name,profession,height,salary,phone_no,home_town,religion,e_date)values(2,'priya','engineer','5 Fit 3 Inc',70000,'+880152','comilla','muslim','19-mar-2016');
insert into brides(b_id,name,profession,height,salary,phone_no,home_town,religion,e_date)values(3,'tuli','singer','5 Fit 4 Inc',51000,'+8801521','norsingdi','hindu','20-feb-2017');
...
insert into brides(b_id,name,profession,height,salary,phone_no,home_town,religion,e_date)values(6,'shruti','model','5 Fit 6 Inc',55000,'+8801565','dhaka','hindu','1-dec-2015');
